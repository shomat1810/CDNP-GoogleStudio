        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <p className="text-slate-600 text-base mt-3 leading-relaxed">
              We operate exclusively as a non-profit cyber defense organization funded by philanthropic grants and community donations. Our network brings together certified incident responders, ethical hackers, privacy attorneys, and empathetic crisis volunteers.
            </p>
            ...
            <div className="bg-slate-900 text-white rounded-2xl p-7 sm:p-8 border border-slate-800 shadow-xl relative overflow-hidden">
              ...
              <div className="space-y-3 border-t border-slate-800 pt-5 text-xs text-slate-300">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-emerald-400">Non-Profit Organization</span>
                </div>
